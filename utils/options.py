...
def get_args():
    parser = argparse.ArgumentParser(description="ICLF Args")
    ######################## general settings ########################
    parser.add_argument("--local_rank", default=0, type=int)
    parser.add_argument("--name", default="iclf", help="experiment name to save")
    ...
    ######################## loss settings ########################
    parser.add_argument("--loss_names",
                        default='itc+id+mlm+itm',
                        help="which loss to use ['mlm', 'cmpm', 'id', 'itc', 'sdm', 'itm']")
    parser.add_argument("--mlm_loss_weight", type=float, default=1.0, help="mlm loss weight")
    parser.add_argument("--id_loss_weight", type=float, default=1.0, help="id loss weight")
    parser.add_argument("--weight", type=float, default=0.9, help="loss weight")
